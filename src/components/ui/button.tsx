...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center whitespace-nowrap border border-transparent bg-clip-padding text-sm font-medium transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
        ...
        cta: `
          ...
          to-[#ff5a2f]
          text-white
          shadow-[0_8px_30px_rgba(255,91,47,0.15)]
          hover:brightness-110
          active:brightness-95
          focus-visible:border-[#ff7448]
          focus-visible:ring-[#ff6738]/40
        `,
      ...
      size: {
        ...
        hero:
          "h-14 min-w-[210px] gap-3 px-8 text-base font-semibold [&_svg:not([class*='size-'])]:size-5",
